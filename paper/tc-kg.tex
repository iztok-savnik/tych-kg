...
\ennotes{Rule for filtering $\land[S_1..S_n]$ all $S_i\preceq\/S_k$ by using algorithmic typing.}
...
\ennotes{$\llb\land[S_1..S_n]\rrb\subseteq\bigcup_{i\in[1..n]}\llb\/S_i\rrb\subseteq\llb\/S\rrb$.}
