...
\notes{Initially, this definition can be skipped!}
...
\notes{Otherwise, the domain and range shoud be $\top$.}
...
\notes{Explanation: Among stored types of t: select the smallest GLB types that have the smallest interpretations.}
\notes{Therefore, smallest search space for queries.} 
