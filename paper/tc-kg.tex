...
The meet of types $T_i^{i\in[1,n]}]$, $M=S\sqcap[T_i]$, is a set of
the maximal lower bound types $M_j^{j\in[1,m]}\in\/M$ such that $M_j$
is lower bound with $M_j\preceq\/T_i^{i\in[1,n]}$, and all other lower
bounds $U$ with $U\preceq\/T_i^{i\in[1,n]}$ entail
...
$M_j\in\sqcap[T_i^{i\in[1,n]}]$ includes solely the interpretation of $M$. The
