...
% on static structure of a KG (merge with the above)
...
\notes{What types can be used for in a KG?}
...
% Types stored in a KG (user-defined types) (merge with the above)
\notes{Is this part of the type-checking method presented below?}
