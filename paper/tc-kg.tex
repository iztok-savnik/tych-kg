...
\notes{Each predicate has the domain and range defined either directly or indirectly if the domain and range is defined for $p$'s super-predicates.}
...
\notes{Formally, the triple types $T_s*p*T_o$ are represented as triples that inlcude solely a predicate and two classes.}
